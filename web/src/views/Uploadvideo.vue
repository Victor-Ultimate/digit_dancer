<template>
  <div class="VideoTest">
    <el-upload style="margin-left:14%;margin-top:5%"
      ...
      :drag="{Plus}"
      action="http://localhost:3000/api/uploadVideo/"
      multiple
...
export default {
  ...
  data () {
    return {
      ...
      // headers: {
      //   Authorization:"Bearer "+ "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI5MTk3YjI1NGQ0ZmI0NmFhYjJmZjU3ZWFkYWRmZTA0MSIsInN1YiI6IjEiLCJpc3MiOiJzZyIsImlhdCI6MTY1OTQ5NjczOCwiZXhwIjoxNjYwNzA2MzM4fQ.4TAHY1TuFLGEprwd8VV9KHOO08H07nVVOOvWees3rA4",
      // },
      // success(resp){
      //   console.log(resp);
      // },
